 ...
 * contraste.
 * Created on 30 de marzo de 2021, 14:32
 */
...
/*          puertos B(6,7 y 8) como entradas para el teclado                  */
/* Argumentos: no tiene                                                       */
/* Retorna: nada                                                              */
/******************************************************************************/
void Config_Port_Mcu(void)
{
    AD1PCFG = 0x1FFF;   //todos los puertos A/D como digital IO
    ...
    //ODCBbits.ODB4 = 1;
    //ODCBbits.ODB5 = 1;
    TRISB = 0x0000;     //all port B is output
    LATB = 0x0000;      //all off
