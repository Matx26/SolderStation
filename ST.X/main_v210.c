 ...
 * contraste.
 * Created on 13 de junio de 2021, 01:21
 */
...
/* Funcion: Configura la senal PWM, La frecuencia sera de 15625Hz lo que      */
/*         implica que el periodo sera de 64us, se elige ese valor de frec.   */
/*         porque es la mayor valor que me da una resolucion exacta de 10bits.*/
/*         El prescaler de los timer sera 1:1 por lo que para obtener el      */
/*         periodo de 64us PR1 debe valer (PWM_Period/Tcy -1) = 1023          */
/* Argumentos: no tiene                                                       */
/* Retorna: nada  */
/******************************************************************************/
void Config_OutputCapture1(void)
{
    ...
    PR2 = 16382;     //especificamos el valor de PR2 (del TIMER2) para obtener un periodo de la señal pwm de 64us
    
    //Configuro el timer3 como base de tiempo para Output capture 1
...
void Config_AD(void)
{
   ...
   AD1CON1bits.SSRC = 0b111;    //el inicio de la conversioin esta bajo el control del clock A/D
   ...
   AD1CON2bits.SMPI = 0b1111;    //0b1111; //genera una interrupcion por cada conversiones
   ...
   AD1CON3bits.SAMC = 0b11110;  //0b11110; // Sanc = 3TAD + 0.750us = entre 4 y 5 TAD (se usa 5)
   AD1CON3bits.ADCS = 0b00101111;   //0b00101111;    //TDA = TCy = 2/32M = 0.625uS   
...
void __attribute__((interrupt, auto_psv)) _ADC1Interrupt(void)
{
    ...
    ADCValue = ADC1BUFF;      //tranfiero el valor del ADC 
    ...
    OC1RS = (uT*5+16);     //escribimos en el registro que define el ciclo de trabajo de la señal PWM
